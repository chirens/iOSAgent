...
struct SkillInstaller {
    ...
    private static func searchDirect(query: String, perPage: Int) async throws -> [SkillGitHubSearchResult] {
        ...
        req.setValue("iOSAgent/9.0.25", forHTTPHeaderField: "User-Agent")
